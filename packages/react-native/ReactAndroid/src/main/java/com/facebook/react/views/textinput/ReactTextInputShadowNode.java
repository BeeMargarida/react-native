...
public class ReactTextInputShadowNode extends ReactBaseTextShadowNode
  ...
  // @NEW (this is duplicated code, find a way to clean this up)
  public void addSpansFromStyleAttributes(SpannableStringBuilder workingText) {
    EditText editText = Assertions.assertNotNull(mInternalEditText);
    ...
    workingText.setSpan(
      new ReactForegroundColorSpan(editText.getCurrentTextColor()), 0, workingText.length(), spanFlags);
